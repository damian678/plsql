...
insert into ksiazki values (1, 'zaproponuj-autora', 'zaproponuj-tytul', 1);

grant select on czytelnicy to mat17uzfina4;--nadaje uprawnienia użytkownikowi dla select
...
revoke select on czytelnicy from mat17uzfina4;--odbiera uprawnienia użytkownikowi dla select
select * from mat17uzfina4;

--6
grant select, insert on ksiazki to mat17uzfina4;-- nadaje uprawnienia użytkownikow z tabeli ksiazki 
--do wstawiania wierszy i dla select do tej tabeli
select * from mat17uzfina4.ksiazki;
insert into  mat17uzfina4.ksiazki values(2, 'Celko', 'SQL', null);
select * from mat17uzfina4.ksiazki;
SELECT * FROM ksiazki;
revoke select,insert on ksiazki from  mat17uzfina4;--odbiera uprawnienia u¿ytkownikow z tabeli ksiazki 
--do wstawiania wierszy i dla select do tej tabeli
...
mat17uzfina4.czytelnicy);--nie posiada uprawnień dla nadawania kluczy obcych

grant references on czytelnicy to mat17uzfina4;
create table ksiazki2(sygnatura number primary key, autor varchar2(50), tytul varchar2(500), 
id_czytelnika references 
mat17uzfina4.czytelnicy);--teraz się udało
